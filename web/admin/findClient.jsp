        ...
        <div id="sidebar" class="span3">
            ...
            <c:if test="${empty listProduct}">
                <div class="alert alert-block alert-error fade in">
                    ...
                    <strong>Không có tin tức nào tên "${currentName}" tồn tại !!!</strong>
                </div>
            </c:if>
                            ...
                            <div class="row">	  
                                ...
                                <div class="span3 alignR">
                                    <form class="form-horizontal qtyFrm">
                                        ...
                                        <a href="them-vao-gio-hang.htm?productID=${p.productID}&&cateId=${p.categoryID.categoryID}&&name=${currentName}&&page=${currentPage}&&back=${back}" class="btn btn-large btn-primary"> Xem</a>
                                    ...
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption">
                                            ...
                                            <h4 style="text-align:center">
                                                ...
                                                <a class="btn" href="them-vao-gio-hang.htm?productID=${p.productID}&&cateId=${p.categoryID.categoryID}&&name=${currentName}&&page=${currentPage}&&back=${back}">Xem 
