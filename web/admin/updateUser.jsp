...
<mt:layout title="Update User Page">   
                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div id="collapseOne" class="accordion-body collapse in body">
                            <spring:form action="updateUser.htm" class="form-horizontal" commandName="u" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <spring:input path="password" type="text" id="password" name="password" placeholder="" class="form-control"/>
                                ...
                                <div class="form-actions no-margin-bottom" style="text-align:center;">
                                    <c:choose>
                                        <c:when test="${profilemode == 1}">
                                            <a href="index.htm" type="button" class="btn btn-default">Quay lại</a>
                                        </c:when>
                                        <c:otherwise>
