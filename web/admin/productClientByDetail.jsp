        ...
        <div id="sidebar" class="span3">
            ...
            <div class="span9">
                <ul class="breadcrumb">
                    ...
                    <li class="active">${listIndexDetail.description}</li>
            </ul>
            <h4> ${listIndexContenDetail.description}</h4>
            <p>
                Bởi <span style="color: red;">${listIndexDetail.producerID.name}</span>
                <span>
                ...
                <span> - </span>
                <span> Ngày  <fmt:formatDate pattern="dd/MM/yyyy" value="${listIndexDetail.createDate}"/></span>
            </p>
            <hr class="soft">
            <p>
