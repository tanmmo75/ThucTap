...
<mt:layout title="Update User Group Page">   
                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div id="collapseOne" class="accordion-body collapse in body">
                            <spring:form action="updateUserGroup.htm" class="form-horizontal" commandName="ug" method="post">
                                <spring:hidden path="userGroupID"/>
