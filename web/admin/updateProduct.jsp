                    ...
                    <div class="box">
                        ...
                        <div id="collapseOne" class="accordion-body collapse in body">
                            <spring:form action="updateProduct.htm" class="form-horizontal" commandName="p" method="post">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-2">Mã tin</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group">
                                    <label for="text1" class="control-label col-lg-2">chi tiết</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-2">Nguồn tin</label>
                                    <div class="col-lg-10">
